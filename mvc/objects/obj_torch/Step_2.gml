...
{dd=-nearest.speed*3}
dd=0
if instance_number(obj_player1_car) >= 1
{
...
{
if !keyboard_check(vk_up)
{draw_sprite_ext(spr_reflection,0,nearest.x+lengthdir_x(-col,nearest.image_angle)-global.surfacex,nearest.y+lengthdir_y(-col,nearest.image_angle)-global.surfacey,isd/5,1+isd/5-.4,nearest.image_angle,c_white,nearest.alpha-light_alpha+.5)}
else
{draw_sprite_ext(spr_reflection,0,nearest.x+lengthdir_x(-col,nearest.image_angle)-global.surfacex,nearest.y+lengthdir_y(-col,nearest.image_angle)-global.surfacey,isd/5,1+isd/5-.4,nearest.image_angle,c_red,nearest.alpha-light_alpha+1)}
}
