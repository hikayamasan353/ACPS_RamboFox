...
if reverse_var>0{reverse_var-=reverse_loss}

if reverse_var>reverse_topspeed{reverse_var=reverse_topspeed}
...
__view_set( e__VW.XView, 1, (__view_get( e__VW.XView, 1 )*5+(xx-(__view_get( e__VW.WView, 0 )/2)))/6 );
__view_set( e__VW.YView, 1, (__view_get( e__VW.YView, 1 )*5+(yy-(__view_get( e__VW.HView, 0 )/2)))/6 );
