...
if islight_on
{
	...
	draw_sprite_ext(spr_carlight,0,x+xx2,y+yy2,image_xscale*size_scale,image_yscale*size_scale,image_angle,light_color,min(.5-light_alpha,brake_alpha))
	if !keyboard_check(vk_up)
		if reverse_switch
		{
			draw_sprite_ext(spr_carlight,0,x+xx2,y+yy2,image_xscale*size_scale,image_yscale*size_scale,image_angle,light_color,min(1-light_alpha,brake_alpha))
			if keyboard_check(vk_down)
			{
				draw_sprite_ext(spr_carlight,0,x+xx2,y+yy2,image_xscale*size_scale,image_yscale*size_scale,image_angle,c_white,min(.5,brake_alpha))
			}
		}
	if keyboard_check(vk_up)
		if reverse_switch
		{
			draw_sprite_ext(spr_carlight,0,x+xx2,y+yy2,image_xscale*size_scale,image_yscale*size_scale,image_angle,c_red,min(1,1))
		}
	if reverse_switch=0
		if keyboard_check(vk_down)
		{
			draw_sprite_ext(spr_carlight,0,x+xx2,y+yy2,image_xscale*size_scale,image_yscale*size_scale,image_angle,c_red,min(.5,brake_alpha))
		}
}


if islight_on=1
draw_sprite_ext(spr_carlight,0,x+xx2,y+yy2,image_xscale*size_scale,image_yscale*size_scale,image_angle,light_color,min(.5,brake_alpha))
...
if islight_on=1
draw_sprite_ext(spr_carlight,0,x+xx2,y+yy2,image_xscale*size_scale,image_yscale*size_scale,image_angle,light_color,.5)
