...
mid_x=surf_mid_x+lengthdir_x(point_distance(global.mid_x,global.mid_y,surf_mid_x,surf_mid_y)/(__view_get( e__VW.WView, 0 )/mean(z1,z2)),point_direction(global.mid_x,global.mid_y,surf_mid_x,surf_mid_y))
mid_y=surf_mid_y+lengthdir_y(point_distance(global.mid_x,global.mid_y,surf_mid_x,surf_mid_y)/(__view_get( e__VW.WView, 0 )/mean(z1,z2)),point_direction(global.mid_x,global.mid_y,surf_mid_x,surf_mid_y))
